...
public class NumberAnalyzer {
    public static void main(String[] args) {
        // Allow us to cache input from the user using our imported package  
        Scanner scanner = new Scanner(System.in);

        // Prompt for input
        System.out.print("Enter a number: ");

        // creating a variable that will save the integer input from the user
        ...
        // we are taking the absolute value of the number and taking the modular math remainder of 3 of it to store within a 
        // variable to use within the switch condition.

public class Main {
    public static void main(String[] args) {
        ...
        Book bookTest = new Book("Code is Law", "Anthony Davis", 100.00); 
        ...
        bookTest.setPublisher("Davis Company");
        ...
        System.out.println("Book Test Details (full price): " + bookTest.getDetails()); 
